...
import (
	...
	terraformconfig "k8s.io/kube-deploy/cluster-api/cloud/terraform/terraformproviderconfig"
	terraformconfigv1 "k8s.io/kube-deploy/cluster-api/cloud/terraform/terraformproviderconfig/v1alpha1"
...
func (tf *TerraformClient) SetupRemoteMaster(master *clusterv1.Machine) error {
	...
	cmd = exec.Command(
		...
		"-r", "/Users/karangoel/.gvm/pkgsets/go1.9.2/global/src/k8s.io/kube-deploy/cluster-api/cloud/terraform/bin/",
