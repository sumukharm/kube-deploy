...
package terraformproviderconfig
...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*TerraformProviderConfig).DeepCopyInto(out.(*TerraformProviderConfig))
			return nil
		}, InType: reflect.TypeOf(&TerraformProviderConfig{})},
	)
}
...
func (in *TerraformProviderConfig) DeepCopy() *TerraformProviderConfig {
	...
	out := new(TerraformProviderConfig)
	in.DeepCopyInto(out)
	return out
}
